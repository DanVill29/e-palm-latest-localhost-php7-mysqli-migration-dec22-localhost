...
<!-- Subejct-->
  ...
  <section id="about" class="about-section">
    ...
    <div class="panel-group" id="accordion">
              ...
              <h3 class="panel-title"><a href="#"><strong>ECON 1: Basic Economics Taxation, Agrarian Reform</strong></a></h3>
...
<iframe class="embed-responsive-item" width="100%" height="300" src="//www.youtube.com/embed/pBSkHQv_SLg?list=PLvj4mJQXMGWL7xAykc62yitDx75qp_Vuf"?badge=0&amp;autoplay=1&amp;html5=1" frameborder="0" allowfullscreen=""></iframe>
                </div>
            </div>
        </div>
    </div>
...
<br>
            ...
            <div id="collapseTenL" class="panel-collapse collapse">
                <div class="panel-body">
								...
								<a class="btn btn-success" href="?addcom=1&subject=6"><strong>Forums and Add comments</strong></a><br>
			<br>
...
?>	
	<hr>
			...
			<a class="btn btn-success" href="?gotoquiz=8"><strong>Go to Quiz/Exercise/Exam</strong></a><br>
