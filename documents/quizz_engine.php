...
//echo $subject_id.$quiz_id;
	$result3 = mysql_query("SELECT * FROM quizz where subject='$subject_id'");
	$count3=mysql_num_rows($result3);
	
if ($count3 > 0) {

$quizget = mysql_fetch_array($result3);
$quiz_id=$quizget["quizz_id"];

	$result = mysql_query("SELECT * FROM student left join subject on student.student_id=subject.student_id where subject.subject='$subject_id' order by student.student_id asc");
...
if ($count > 0) {
	 ...
	 $result2 = mysql_query("SELECT * from quiz_results left join subject on quiz_results.student_id=subject.student_id where subject.subject='$subject_id' and quiz_results.student_id=$student_id and quiz_results.quiz_id=$quiz_id");
...
if ($count > 0) {
	 ...
	 $student_id=$row["student_id"];
	 $result2 = mysql_query("SELECT * from quiz_results left join subject on quiz_results.student_id=subject.student_id where subject.subject='$subject_id' and quiz_results.student_id='$student_id'");
	 $count2=mysql_num_rows($result2);
	 $rowstatus='active';
	 if ($count2 > 0) {
	 $user_data2=mysql_fetch_array($result2);
...
{
$result = mysql_query("SELECT * FROM instructor WHERE id='$instructor_id' and password='$password'");
$count=mysql_num_rows($result);
...
{
$result = mysql_query("SELECT * FROM student WHERE student_id='$student_id' and password='$password'");
$count=mysql_num_rows($result);
...
public function show_allsubjects($year_level)
{
	...
	$result3 = mysql_query("SELECT * FROM subject_info where year_level='$year_level' order by id asc");
	$count3=mysql_num_rows($result3);
...
if($year_level==2)
{
	...
	$result3 = mysql_query("SELECT distinct(subject_id) FROM enrolled_subjects where student_id='$student_id' and year_level='2' order by id asc");
	$count3=mysql_num_rows($result3);
...
else
{
	...
	$result3 = mysql_query("SELECT distinct(subject_id) FROM enrolled_subjects where student_id='$student_id' and subject_id <> 0 and year_level='1' order by id asc");
	$count3=mysql_num_rows($result3);
...
{
	$result3 = mysql_query("SELECT * FROM subject_info where id='$subject_id'");
	$count3=mysql_num_rows($result3);
...
{
mysql_query("INSERT INTO student(student_id,gender,firstname,lastname,age,address,cellnumber,course,password,email,date_modified) values('','$gender','$fname','$lname','$age','$address','$cellnumber','$course','$password','$email','$date_modified')") or die(mysql_error());
$result = mysql_query("SELECT * FROM student order by student_id desc");
$count=mysql_num_rows($result);
if($count>0)
{
...
{
mysql_query("INSERT INTO subject(subject_id,subject,subject_name,student_id,date_modified) values ('','$subject1','Facilitating Learning','$student_id2','$date_modified')") or die(mysql_error());
mysql_query("INSERT INTO subject(subject_id,subject,subject_name,student_id,date_modified) values ('','$subject2','','$student_id2','$date_modified')") or die(mysql_error());
mysql_query("INSERT INTO subject(subject_id,subject,subject_name,student_id,date_modified) values ('','$subject3','','$student_id2','$date_modified')") or die(mysql_error());
mysql_query("INSERT INTO subject(subject_id,subject,subject_name,student_id,date_modified) values ('','$subject4','','$student_id2','$date_modified')") or die(mysql_error());
}
return $student_id2;
...
{
mysql_query("INSERT INTO student(student_id,gender,firstname,lastname,age,address,cellnumber,course,password,email,year_level,date_modified) values('','$gender','$fname','$lname','$age','$address','$cellnumber','$course','$password','$email','$year_level','$date_modified')") or die(mysql_error());
$result = mysql_query("SELECT * FROM student order by student_id desc");
$count=mysql_num_rows($result);
if($count>0)
{
...
if($year_level==1)
{
	$result3 = mysql_query("SELECT * FROM enrolled_subjects where student_id='$student_id' and subject_id='$subject'");
	$count3=mysql_num_rows($result3);
	
	if ($count3 == 0) {
	mysql_query("INSERT INTO enrolled_subjects(id,student_id,subject_id,year_level,semester) values ('','$student_id','$subject','1','1')") or die(mysql_error());
	}
...
else if($year_level==2)
{
	...
	if ($count3 == 0) {
	mysql_query("INSERT INTO enrolled_subjects(id,student_id,subject_id,year_level,semester) values ('','$student_id','$subject','2','1')") or die(mysql_error());
	}
}
}
...
{
mysql_query("UPDATE quizz SET showscore='$toshow' WHERE quizz_id='$toshowid'");
}
...
{
	//echo 'asdas';
mysql_query("UPDATE quiz_results SET feedback='$feedback' WHERE student_id=$student_id and quiz_id=$quizz_id");
}
...
{
mysql_query("UPDATE answer SET result='$updateans_id' WHERE answer_id='$answerid'");

//
$result20 = mysql_query("SELECT * FROM answer WHERE student_id ='$student_id' and quizz_id='$quiz_id'");
$count20=mysql_num_rows($result20);
if($count20>0)
{
while($user_data3 = mysql_fetch_array($result20))
{
...
$result2 = mysql_query("SELECT * FROM answer WHERE student_id ='$student_id' and quizz_id='$quiz_id' and question_id='$value'");
...
//update_answer
mysql_query("UPDATE quiz_results SET score='$total_right', wrong_answer='$total_wrong' WHERE quiz_id='$quiz_id'
...
mysql_query("INSERT INTO discussion(id,subject,name,added_by,date_modified) values('','$subject','$name','$instructor_id','$date_modified')") or die(mysql_error());
}
...
$d=time();
$date_modified=date("Y-m-d h:i:sa", $d);
mysql_query("INSERT INTO comment(id,name,discussion_id,added_by,date_modified) values('','$name','$discussion_id','$by','$date_modified')") or die(mysql_error());
}
...
$result = mysql_query("SELECT * FROM grades WHERE subject='$subject' and student_id='$student_id'");
$count=mysql_num_rows($result);
if($count>0)
{
//$user_data = mysql_fetch_array($result);
//$result3=$user_data['result'];
//mysql_query("UPDATE grades SET prelim='$prelim',midterm='$midterm',prefinal='$pre_final',final='$final' WHERE subject='$subject' and student_id='$student_id'");
//echo 'naa';
if($periodtochange=='Prelim')
{
//echo $prelim;
mysql_query("UPDATE grades SET prelim='$prelim',cleared='$cleared' WHERE subject='$subject' and student_id='$student_id'");
}
else if($periodtochange=='Midterm')
{
mysql_query("UPDATE grades SET midterm='$midterm',cleared='$cleared' WHERE subject='$subject' and student_id='$student_id'");
}
else if($periodtochange=='Pre-Final')
{
mysql_query("UPDATE grades SET prefinal='$pre_final',cleared='$cleared' WHERE subject='$subject' and student_id='$student_id'");
}
else if($periodtochange=='Final')
{
mysql_query("UPDATE grades SET final='$final',cleared='$cleared' WHERE subject='$subject' and student_id='$student_id'");
}
...
mysql_query("INSERT INTO grades(id,student_id,prelim,midterm,prefinal,final,subject,cleared) values('','$student_id','$prelim','$midterm','$pre_final','$final','$subject','$cleared')") or die(mysql_error());
//echo 'walay sulod!';
}
}
...
//if($count>0)
//{
mysql_query("INSERT INTO quizz(quizz_id,subject,name,quiztype,showscore,quiz_time) values ('','$subject','$name','$quiztype','$showscore','$quiz_time')") or die(mysql_error());
$result2 = mysql_query("SELECT * FROM quizz order by quizz_id desc");
...
{
mysql_query("INSERT INTO question(question_id,title,question_type_id,quizz_id) values ('','$q','2','$s')") or die(mysql_error());
...
$question_id= $user_data['question_id'];
mysql_query("INSERT INTO question_values1(question_id,value,answer) values ('$question_id','$q','$a')") or die(mysql_error());
mysql_query("INSERT INTO question_enum_values(question_id,enum_value_id,name) values ('$question_id','','$a')") or die(mysql_error());
return $question_id;
}
}
...
{
mysql_query("INSERT INTO question_enum_values(question_id,enum_value_id,name) values ('$s','','$a')") or die(mysql_error());
}
else
echo 'no qtype';
...
{
$result = mysql_query("SELECT question_id FROM answer WHERE question_id = '$value' and student_id='$student_id'
...
$result = mysql_query("SELECT question_id FROM answer WHERE question_id = '$value2' and student_id='$student_id'");
$count=mysql_num_rows($result);
...
{
$result = mysql_query("SELECT * FROM question WHERE quizz_id=$quizz_id order by question_id asc");
$count=mysql_num_rows($result);
...
if($count>0)
{
$result1 = mysql_query("SELECT * FROM question WHERE quizz_id=$quizz_id");
while($user_data3 = mysql_fetch_array($result1))
{
$question_id_array[]= $user_data3['question_id'];
}
}
...
{
$result = mysql_query("SELECT question_id FROM question WHERE quizz_id=$quizz_id order by question_id asc");
$count=mysql_num_rows($result);
...
{
$result = mysql_query("SELECT question_id FROM answer WHERE question_id = $question_id and result='1' and student_id=$student_id");
$count=mysql_num_rows($result);
...
{
$result = mysql_query("SELECT question_type_id FROM question WHERE question_id = $question_id");
$user_data = mysql_fetch_array($result);
...
{
$result = mysql_query("SELECT value FROM question_values1 WHERE question_id = $question_id");
$user_data = mysql_fetch_array($result);
...
$result3 = mysql_query("SELECT * FROM question_enum_values WHERE question_id = $question_id");
...
if($count>0)
{
while($user_data = mysql_fetch_array($result3))
{
...
{
$result2 = mysql_query("SELECT name FROM question_enum_values WHERE question_id = $question_id and enum_value_id=$radio");
$user_data2 = mysql_fetch_array($result2);
...
$d=time();
$date_modified=date("Y-m-d h:i:sa", $d);
mysql_query("INSERT INTO answer(answer_id,question_id,value,result,student_id,quizz_id,date_modified) values ('','$question_id','$ans','$result','$student_id','$quizz_id','$date_modified')") or die(mysql_error());
}
...
if($qtype_id==1)
{
$result2 = mysql_query("SELECT answer FROM question_values1 WHERE question_id = $question_id");
$user_data = mysql_fetch_array($result2);
...
{
$result = mysql_query("SELECT * FROM answer WHERE student_id ='$student_id' and quizz_id='$quizz_id'");
...
$quiztyperes = mysql_query("SELECT * FROM quizz WHERE quizz_id='$quizz_id'");
...
$total_right=0;
$total_wrong=0;
$quiztype = mysql_fetch_array($quiztyperes);
...
$result2 = mysql_query("SELECT * FROM answer WHERE student_id ='$student_id' and quizz_id='$quizz_id' and question_id='$value'");
$count=mysql_num_rows($result2);
...
$d=time();
$date_modified=date("Y-m-d h:i:sa", $d);
mysql_query("INSERT INTO quiz_results(id,student_id,quiz_id,score,wrong_answer,total_questions,date_modified) values ('','$student_id','$quizz_id','$total_right','$total_wrong','$count2','$date_modified')") or die(mysql_error());
}
...
$result = mysql_query("SELECT * FROM quiz_results WHERE student_id='$student_id'");
$count=mysql_num_rows($result);
return $count;
}
...
//echo $subjectf;
		...
		/*checking and getting quiz by student and subject */
$result = mysql_query("SELECT * FROM enrolled_subjects WHERE subject_id = '$subject' and student_id='$student_id'");
$count=mysql_num_rows($result);

if($count>0)
{
//echo 'good-this student is a enrolled student for subject1';
$result1 = mysql_query("SELECT * FROM quizz WHERE subject = '$subject' order by quizz_id asc");
...
// echo '<br>';
 ...
 $result2 = mysql_query("SELECT * FROM answer WHERE quizz_id ='$r' and student_id='$student_id'");
 $count2=mysql_num_rows($result2);
 if($count2>0)
{
...
{
	 $result2 = mysql_query("SELECT * from  enrolled_subjects left join  quiz_results on quiz_results.student_id=enrolled_subjects.student_id where enrolled_subjects.subject_id='$subject' and quiz_results.student_id='$student_id'
...
{
	 $result2 = mysql_query("SELECT * from quiz_results left join enrolled_subjects on quiz_results.student_id=enrolled_subjects.student_id where enrolled_subjects.subject_id='$subject' and quiz_results.student_id='$student_id'
	 and quiz_results.quiz_id='$r'");
	 $count2=mysql_num_rows($result2);
	  if ($count2 > 0) {
	 $user_data2=mysql_fetch_array($result2);
...
// looking for quizz type
	 $result20 = mysql_query("SELECT * from quizz where quizz_id='$value'");
	 $count20=mysql_num_rows($result20);
	  if ($count20 > 0) {
	 $user_data20=mysql_fetch_array($result20);
...
//check the grades cleared value, if 1 , will block, else will allow.
	 $result50 = mysql_query("SELECT * from grades where student_id='$student_id'");
	 $count50=mysql_num_rows($result50);
	  if ($count50 > 0) {
	 $user_data50=mysql_fetch_array($result50);
...
{
mysql_query("DELETE FROM question WHERE question_id='$qidtodelete'");
}

public function delete_multiplechoice($deletenumid)
{
mysql_query("DELETE FROM question_enum_values WHERE enum_value_id='$deletenumid'");
}


public function update_multiplechoice($c,$editnumid)
{
mysql_query("UPDATE question_enum_values SET name='$c' WHERE enum_value_id='$editnumid'");
}


public function delete_quiz($q)
{
mysql_query("DELETE FROM quizz WHERE quizz_id='$q'");
}

public function show_allquizzid()
{
	$result3 = mysql_query("SELECT * FROM quizz order by quizz_id desc");
	$count3=mysql_num_rows($result3);
...
{
	$result3 = mysql_query("SELECT * FROM question where quizz_id='$quiz_id' order by question_id desc");
	$count3=mysql_num_rows($result3);
	...
	if ($count3 > 0) {
	     ...
	     while($row = mysql_fetch_array($result3)) {
		    $question_id=$row["question_id"];
		 	$result4 = mysql_query("SELECT * FROM question_values1 where question_id='$question_id' order by question_id desc");
...
public function show_alldiscussion_inasubject($subject_id,$by)
{
	...
	$result3 = mysql_query("SELECT * FROM discussion where subject='$subject_id' order by id desc");
	$count3=mysql_num_rows($result3);
...
{
	$result3 = mysql_query("SELECT * FROM discussion where id='$id' order by id desc");
    $row = mysql_fetch_array($result3);
	echo '<div id="editor" contenteditable="false" >';
...
{
	$result3 = mysql_query("SELECT * FROM comment where discussion_id='$id' order by id desc");
	$count3=mysql_num_rows($result3);
	...
	if ($count3 > 0) {
		 ...
		 $by=$row["added_by"];
		 	...
		 	$result6 = mysql_query("SELECT * FROM student where student_id='$by'");
...
{
	$result3 = mysql_query("SELECT * FROM enrolled_subjects order by subject_id desc");
	$count3=mysql_num_rows($result3);
	...
	if ($count3 > 0) {
		 ...
		 $student_id=$row['student_id'];
		 	...
		 	$result4 = mysql_query("SELECT * FROM student WHERE student_id='$student_id'");
			$row2 = mysql_fetch_array($result4);
...
{
	$result3 = mysql_query("SELECT * FROM answer WHERE student_id='$student_id' and quizz_id='$quizz_id' order by answer_id desc");
	$count3=mysql_num_rows($result3);
	...
	if ($count3 > 0) {
		 ...
		 //getting question id, value, and its correct answer
		 	$result4 = mysql_query("SELECT * FROM question_values1 WHERE question_id='$qid'");
...
{
	$result3 = mysql_query("SELECT * FROM grades WHERE student_id='$student_id' and subject='$subject'order by id desc");
	$count3=mysql_num_rows($result3);
...
{
mysql_query("DELETE FROM answer WHERE student_id='$student_id' and quizz_id='$quiz_id'");
mysql_query("DELETE FROM quiz_results WHERE student_id='$student_id' and quizz_id='$quiz_id'");
}

public function showquizzes_persubject($subject_id)
{
	$result3 = mysql_query("SELECT * FROM quizz where subject='$subject_id' order by quizz_id desc");
	$count3=mysql_num_rows($result3);
...
{
    $result = mysql_query("SELECT * FROM student where activate='0' order by student_id desc");
    $count=mysql_num_rows($result);
...
$quiz_id=$quizget["quizz_id"];
	...
	$result = mysql_query("SELECT * FROM student left join enrolled_subjects on student.student_id=enrolled_subjects.student_id where enrolled_subjects.subject_id='$subject_id' 
...
if ($count > 0) {
	 ...
	 $result2 = mysql_query("SELECT * from quiz_results left join enrolled_subjects on quiz_results.student_id=enrolled_subjects.student_id where enrolled_subjects.subject_id='$subject_id' and quiz_results.student_id=$student_id and quiz_results.quiz_id=$quiz_id");
	 $count2=mysql_num_rows($result2);
	 $rowstatus='active';
	 if ($count2 > 0) {
	 $user_data2=mysql_fetch_array($result2);
...
echo 'No quiz added yet to a subject';
	...
	$result = mysql_query("SELECT * FROM student left join enrolled_subjects on student.student_id=enrolled_subjects.student_id where enrolled_subjects.subject_id='$subject_id' order by student.student_id asc");
	$count=mysql_num_rows($result);
...
if ($count > 0) {
	 ...
	 $student_id=$row["student_id"];
	 $result2 = mysql_query("SELECT * from quiz_results left join enrolled_subjects on quiz_results.student_id=enrolled_subjects.student_id where enrolled_subjects.subject_id='$subject_id' and quiz_results.student_id='$student_id'");
