...
<br>
        ...
        <input type="text" id="inputPassword" class="form-control" placeholder="Age" required name='age' value=''>
		 ...
		 <br>
				       ...
				       <label>
        <h4>PROF ED 2: Facilitating Learning</h4>
          </label><br>
		  								        <input type="checkbox"  Name="subject2" value="subject2">
				       <label>
        <h4>STRAT 4: Principles of Teaching 1</h4>
          </label><br>
		  								 <input type="checkbox"  Name="subject3" value="subject3">
				       <label>
        <h4>STRAT 5: Developmental Training 1</h4>
          </label><br>
		  		  							            <input type="checkbox"  Name="subject4" value="subject4">
				       <label>
        <h4>ECON 1: Basic Economics Taxation, Agrarian Reform</h4>
          </label><br>
						<hr>
								 </div>
								 								 <br>
