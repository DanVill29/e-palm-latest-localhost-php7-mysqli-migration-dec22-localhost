...
if(!$quizz->check_student_exist2($i,$p))
{
$_SESSION['login'] = FALSE;
...
header("location:login_quizz.php?ep=$i");
}
}
else
       ...
       <a class="navbar-brand" href="home.php"><img src="logo1.png" style="width:90px;height:30px"></img></a>
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="login_student.php">Student</a></li>
...
<br>
 ...
 <form class="form-signin" role="form" method='post' action=''>
    ...
    <p><a href="student_enroll.php" class="btn btn-success btn-block" role="button">ENROLL NOW!</a></p>
