...
<!-- Subejct-->
  ...
  <section id="about" class="about-section">
    ...
    <div class="panel-group" id="accordion">
              ...
              <h3 class="panel-title"><a href="#"><strong>STRAT 4: Principles of Teaching 1</strong></a></h3>
...
<iframe class="embed-responsive-item" width="100%" height="300" src="//www.youtube.com/embed/OGVsYbO8C0Q"?badge=0&amp;autoplay=1&amp;html5=1" frameborder="0" allowfullscreen=""></iframe>
                </div>
            </div>
        </div>
    </div>
...
?>	
	<hr>
			...
			<a class="btn btn-success" href="?gotoquiz=6"><strong>Go to Quiz/Exercise/Exam</strong></a><br>
